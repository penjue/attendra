...
function App() {
  ...
  const generateActivationLink = async (device: Device) => {
    ...
    try {
      ...
      setDeviceMessage('Secure tablet activation link and QR code generated. A new activation invalidates the previous device key.');
